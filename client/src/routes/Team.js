...
function Team() {
  var teammates = [
    ...
    ["홍의", "BE Leader", "지금 머리가 안돌아가서 자고인나서 말해도될까요 ㅠㅠ", "똥파리, 2008", "이번 프로젝트 주제를 진행하면서 찾아보다 보고싶게 된 영화. 세상은 엿같고, 핏줄은 더럽게 아프다! 영화의 시놉시스도 눈에 띄고 주인공 이름도 팀원이름인 상훈이여서 더더욱 정이 가는 영화이다. 팀장님도 추천을 잔뜩해준 영화!!!"],
